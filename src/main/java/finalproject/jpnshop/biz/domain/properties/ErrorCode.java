...
public enum ErrorCode {
    ...
    PRODUCT_EXIST(400, "이미 추가된 상품입니다." ),
    ...
    ORDER_COMP_ERROR(400, "배송이 완료된 상품은 취소할 수 없습니다." ),
    PASSWORD_NOT_FOUND(400, "비공개 글은 비밀번호를 필수로 입력해야합니다."),
    PASSWORD_NOT_CORRECT(400, "비밀번호가 올바르지 않습니다."),
    MAGAZINE_NOT_FOUND(404, "매거진을 찾을 수 없습니다."),
    REVIEW_ALREADY_EXIST(400, "이미 리뷰를 작성했습니다."),
    PAYMENT_NOT_FOUND(404, "결제 정보를 찾을 수 없습니다."),
    USERNAME_ALREADY_EXIST(400, "이미 존재하는 아이디입니다."),
    EMAIL_ALREADY_EXIST(400, "이미 존재하는 이메일입니다."),
    JWT_ERROR(401,"JWT 토큰이 만료되었습니다.");
